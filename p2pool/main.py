...
import bitcoin.p2p as bitcoin_p2p, bitcoin.data as bitcoin_data, bitcoin.networks as bitcoin_networks
...
def run():
    ...
    parser.add_argument('--net',
        help='use specified network (default: yacoin)',
        action='store', choices=sorted(realnets), default='copperbars', dest='net_name')
